...
if [ -z "$1" ]; then
  echo -e "Usage: $0 service-name trigger-name 'Trigger title' 'Trigger description'";
  exit 1;
fi
...
placeholderDirectory="$root_dir/back_end/cli/assets/trigger-webhook-service"
