...
- [Table `users` - Gestion des utilisateurs](#table-users---gestion-des-utilisateurs)
- [Table `services` - Services externes](#table-services---services-externes)
- [Table `connections` - Connexions authentifiées](#table-connections---connexions-authentifiées)
- [Table `zaps` - Workflows d'automatisation](#table-zaps---workflows-dautomatisation)
- [Table `zap_steps` - Étapes d'un workflow](#table-zap_steps---étapes-dun-workflow)
- [Table `triggers` - Événements déclencheurs](#table-triggers---événements-déclencheurs)
- [Table `actions` - Actions exécutables](#table-actions---actions-exécutables)
- [Table `zap_executions` - Historique des exécutions](#table-zap_executions---historique-des-exécutions)
- [Table `step_executions` - Détail par étape](#table-step_executions---détail-par-étape)
- [Table `webhooks` - Réception temps réel](#table-webhooks---réception-temps-réel)
- [Table `service_fields` - Configuration dynamique](#table-service_fields---configuration-dynamique)
- [Table `data_transformations` - Le cœur de Zapier](#table-data_transformations---le-cœur-de-zapier)
- [Table `execution_logs` - Debugging avancé](#table-execution_logs---debugging-avancé)
- [Relations et flux de données](#relations-et-flux-de-données)
- [Lexique des termes techniques](#lexique-des-termes-techniques)
