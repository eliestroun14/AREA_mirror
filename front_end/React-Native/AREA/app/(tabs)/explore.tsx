...
import NewsCardCard from '@/components/molecules/news-card/news-card'
...
import ServiceCardCard from '@/components/molecules/service-card/service-card'
import AppletCardCard from '@/components/molecules/applets-card/applets-card'
        ...
        <View style={styles.container}>
          ...
          <View style={styles.header}>
            ...
            <View style={styles.Cards}>
              <ServiceCardCard appName='Youtube'
              appLogoPath={youtube}
            ...
            <View style={styles.Cards}>
              <AppletCardCard description='Create an event on youtube in a linkedin post !'
              appName='Youtube'
            ...
            <View style={styles.Cards}>
              <ServiceCardCard appName='Linkedin'
            ...
            <View style={styles.Cards}>
              <NewsCardCard category='Linkedin'
