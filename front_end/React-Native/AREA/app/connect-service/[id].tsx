...
const ConnectService = (props: Props) => {
  ...
  const handleOAuth = async () => {
    try {
      ...
      const oauth2Slug = getServiceSlug(service);
      ...
      console.log('1. Backend will redirect to service OAuth with backend callback');
      console.log('2. Service will redirect to backend callback');
      ...
      if (redirect) {
        ...
        console.log('We need to use WebBrowser.openBrowserAsync with full redirect chain');
        console.log('This should match the backend flow and catch the redirect properly');
        
        console.log('--- ENHANCED DEBUG ---');
        console.log('About to call WebBrowser.openBrowserAsync with:');
