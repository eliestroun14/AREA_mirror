...
export default function TriggersPage() {
  ...
  const handleTriggerClick = (triggerId: number) => {
    router.push(`/create/${zapId}/triggers/${serviceId}/${triggerId}`)
  }
  ...
  useEffect(() => {
    const fetchServiceAndTriggers = async () => {
      try {
        ...
        const triggersData = await apiService.getTriggersByService(serviceId)
      ...
      <Container maxWidth="lg" sx={{ py: 6 }}>
        {triggers.length === 0 ? (
          ...
          >
            ...
            >
              This service doesn&apos;t have any triggers configured yet.
            </Typography>
            <Button
              onClick={handleBackClick}
              variant="contained"
